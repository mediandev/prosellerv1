    ...
    for (let i = 0; i < relatoriosParaEnviar.length; i++) {
      ...
      try {
        await api.comissoes.enviarEmailRelatorio({
          to: relCompleto.vendedorEmail,
          vendedorNome: relCompleto.vendedorNome,
          periodo: formatPeriodo(relCompleto.relatorio.periodo),
          totalVendas: relCompleto.totalVendas,
          totalComissoes: relCompleto.totalComissoes,
          valorLiquido: relCompleto.relatorio.valorLiquido,
          saldo: relCompleto.relatorio.valorLiquido - (relCompleto.relatorio as any).totalPago,
        });
        ...
        resultados.falhas.push({
          vendedor: relCompleto.vendedorNome,
          motivo: error?.message || "Erro ao processar"
        });
      }
    }
