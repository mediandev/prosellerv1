-- ============================================================================
-- Migration 076: Adicionar parâmetro p_ref_tipo_pessoa_id_FK em update_cliente_v2
-- ============================================================================
-- Descrição: Adiciona suporte para atualizar o tipo de pessoa do cliente
-- Data: 2026-01-29
-- ============================================================================

-- Remover todas as versões existentes da função
DROP FUNCTION IF EXISTS public.update_cliente_v2 CASCADE;
...
BEGIN
  ...
  IF p_ref_tipo_pessoa_id_FK IS NOT NULL THEN
    IF NOT EXISTS (
      SELECT 1 FROM public.ref_tipo_pessoa
      WHERE ref_tipo_pessoa_id = p_ref_tipo_pessoa_id_FK
    ) THEN
  ...
  IF p_condicoes_pagamento_ids IS NOT NULL THEN
    ...
    DELETE FROM public.condições_cliente
...
COMMENT ON FUNCTION update_cliente_v2 IS 'Atualiza cliente com suporte para ref_tipo_pessoa_id_FK, grupo_id, segmento_id, ref_situacao_id, empresa_faturamento_id e condições de pagamento';
