-- ============================================================================
-- Migration 029: Incluir segmento_nome na resposta de get_cliente_completo_v2
-- ============================================================================
-- O objeto cliente na resposta passa a incluir segmento_nome (nome do segmento
-- em segmento_cliente) para exibição na tabela e no filtro.
-- ============================================================================
...
BEGIN
  ...
  -- Incluir segmento_nome no objeto cliente via JOIN com segmento_cliente
  SELECT JSON_BUILD_OBJECT(
    'cliente', (row_to_json(c.*)::jsonb || jsonb_build_object('segmento_nome', sc.nome))::json,
...
'Busca cliente completo com contato, endereço, vendedores, condições_cliente, conta_corrente_cliente e segmento_nome';
