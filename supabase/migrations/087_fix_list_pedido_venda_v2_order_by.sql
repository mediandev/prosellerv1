-- Migration 087: Fix ORDER BY with JSON_AGG in list_pedido_venda_v2
-- ============================================================================
-- Bug: `ORDER BY pv.data_venda ...` em query com agregacao (JSON_AGG) causa:
--   "column pv.data_venda must appear in the GROUP BY clause..."
-- Fix: paginar/ordenar em subquery e aplicar ORDER BY dentro do JSON_AGG.
-- Data: 2026-02-10
-- ============================================================================
...
BEGIN
  ...
  -- Verificar tipo de usuario (backoffice vs vendedor)
