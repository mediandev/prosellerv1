-- ============================================================================
-- Migration 067: Funções RPC para Conta Corrente (v2)
-- ============================================================================
-- Descrição: Cria funções RPC para gerenciamento completo de conta corrente
--            (compromissos e pagamentos) seguindo padrão arquitetural
-- Data: 2026-02-03
-- ============================================================================

-- ============================================================================
-- 1. FUNÇÃO: list_conta_corrente_v2
-- ============================================================================
-- Lista compromissos com filtros, paginação e estatísticas
-- ============================================================================
...
BEGIN
  ...
  GROUP BY ccc.id, ccc.cliente_id, c.nome, c.nome_fantasia, gr.nome, ccc.vendedor_uuid, 
...
'Lista compromissos de conta corrente com filtros, paginação e estatísticas';

GRANT EXECUTE ON FUNCTION list_conta_corrente_v2 TO authenticated;
GRANT EXECUTE ON FUNCTION list_conta_corrente_v2 TO anon;

-- ============================================================================
-- 2. FUNÇÃO: get_conta_corrente_v2
-- ============================================================================
-- Busca compromisso por ID com pagamentos relacionados
-- ============================================================================
...
GRANT EXECUTE ON FUNCTION get_conta_corrente_v2 TO authenticated;
GRANT EXECUTE ON FUNCTION get_conta_corrente_v2 TO anon;

-- ============================================================================
-- 3. FUNÇÃO: create_conta_corrente_v2
-- ============================================================================
-- Cria novo compromisso com validações
-- ============================================================================
...
'Cria um novo compromisso de conta corrente com validações';

GRANT EXECUTE ON FUNCTION create_conta_corrente_v2 TO authenticated;

-- ============================================================================
-- 4. FUNÇÃO: update_conta_corrente_v2
-- ============================================================================
...
'Atualiza um compromisso existente com validações';

GRANT EXECUTE ON FUNCTION update_conta_corrente_v2 TO authenticated;

-- ============================================================================
-- 5. FUNÇÃO: delete_conta_corrente_v2
-- ============================================================================
-- Soft delete de compromisso (não implementado - tabela não tem deleted_at)
-- ============================================================================
-- Nota: A tabela conta_corrente_cliente não possui campo deleted_at
-- Se necessário, adicionar em migration separada
-- ============================================================================

-- ============================================================================
-- 6. FUNÇÃO: list_pagamentos_conta_corrente_v2
-- ============================================================================
-- Lista pagamentos de um compromisso específico
-- ============================================================================
...
GRANT EXECUTE ON FUNCTION list_pagamentos_conta_corrente_v2 TO authenticated;
GRANT EXECUTE ON FUNCTION list_pagamentos_conta_corrente_v2 TO anon;

-- ============================================================================
-- 7. FUNÇÃO: create_pagamento_conta_corrente_v2
-- ============================================================================
-- Cria novo pagamento vinculado a um compromisso
-- ============================================================================
...
BEGIN
  ...
  IF p_forma_pagamento IS NULL OR LENGTH(TRIM(p_forma_pagamento)) < 2 THEN
    RAISE EXCEPTION 'forma_pagamento é obrigatória';
  END IF;
...
'Cria um novo pagamento vinculado a um compromisso';

GRANT EXECUTE ON FUNCTION create_pagamento_conta_corrente_v2 TO authenticated;

-- ============================================================================
-- 8. FUNÇÃO: update_pagamento_conta_corrente_v2
-- ============================================================================
...
'Atualiza um pagamento existente com validações';

GRANT EXECUTE ON FUNCTION update_pagamento_conta_corrente_v2 TO authenticated;

-- ============================================================================
-- 9. FUNÇÃO: delete_pagamento_conta_corrente_v2
-- ============================================================================
-- Exclui pagamento
-- ============================================================================

CREATE OR REPLACE FUNCTION delete_pagamento_conta_corrente_v2(
  p_id BIGINT,
...
BEGIN
  ...
  IF p_deleted_by IS NOT NULL THEN
    ...
    -- Vendedores só podem excluir pagamentos de compromissos de seus próprios clientes
    IF v_user_tipo = 'vendedor' THEN
      IF NOT EXISTS (
        SELECT 1 FROM public.cliente_vendedores cv
        WHERE cv.cliente_id = v_cliente_id
...
COMMENT ON FUNCTION delete_pagamento_conta_corrente_v2 IS 
'Exclui um pagamento';

GRANT EXECUTE ON FUNCTION delete_pagamento_conta_corrente_v2 TO authenticated;
