-- ============================================================================
-- Migration 073: Fix categoria_id type to UUID in conta_corrente RPC functions
-- ============================================================================
-- Descrição: Corrige o tipo de categoria_id de BIGINT para UUID em todas as
--            funções RPC de conta corrente
-- Data: 2026-02-04
-- ============================================================================

-- ============================================================================
-- 1. ATUALIZAR create_conta_corrente_v2
-- ============================================================================
...
'Cria um novo compromisso de conta corrente com validações (categoria_id como UUID)';

-- ============================================================================
-- 2. ATUALIZAR update_conta_corrente_v2
-- ============================================================================
...
'Atualiza um compromisso existente com validações (categoria_id como UUID)';

-- ============================================================================
-- 3. ATUALIZAR create_pagamento_conta_corrente_v2
-- ============================================================================
...
'Cria um novo pagamento vinculado a um compromisso (categoria_id como UUID)';

-- ============================================================================
-- 4. ATUALIZAR update_pagamento_conta_corrente_v2
-- ============================================================================
...
'Atualiza um pagamento existente com validações (categoria_id como UUID)';
