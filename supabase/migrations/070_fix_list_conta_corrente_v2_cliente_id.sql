-- ============================================================================
-- Migration 070: Fix list_conta_corrente_v2 cliente_id undefined
-- ============================================================================
-- Descrição: Corrige problema de cliente_id retornando "undefined" 
--            usando COALESCE para garantir valores válidos
-- Data: 2026-02-04
-- ============================================================================

-- Corrigir a função list_conta_corrente_v2 para garantir cliente_id correto
...
'Lista compromissos de conta corrente com filtros, paginação e estatísticas (corrigido cliente_id undefined)';
