-- ============================================================================
-- Migration 078: Corrigir ambiguidade na coluna "nome" em update_cliente_v2
-- ============================================================================
-- Descrição: Qualifica todas as referências às colunas da tabela cliente no UPDATE
-- Data: 2026-02-04
-- ============================================================================
...
BEGIN
  ...
  UPDATE public.cliente c SET
    ...
    cpf_cnpj = COALESCE(NULLIF(REPLACE(REPLACE(REPLACE(p_cpf_cnpj, '.', ''), '/', ''), '-', ''), ''), c.cpf_cnpj),
...
COMMENT ON FUNCTION update_cliente_v2 IS 'Atualiza cliente com suporte para ref_tipo_pessoa_id_fk - Todas as colunas qualificadas para evitar ambiguidade';
