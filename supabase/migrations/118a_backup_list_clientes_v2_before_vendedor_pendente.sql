-- 116a_backup_list_clientes_v2_before_vendedor_pendente.sql
--
-- BACKUP da definição atual de list_clientes_v2, capturada via
-- pg_get_functiondef em 2026-05-18 antes da migration 116 que permite
-- vendedor visualizar os clientes pendentes que ele mesmo criou.
--
-- NÃO APLICAR EM CONDIÇÕES NORMAIS — referência/rollback.
